...
Searched `label:Receipts newer_than:8d` (5 threads found; 3 were already in
the ledger from the initial backfill and skipped as duplicates).

| Vendor | Date | Amount | Note |
|---|---|---|---|
| Breezeway | 2026-08-05 | $49.98 | Monthly subscription receipt (Jul 1–Jul 31 billing period). Same price as last month. |
| Petti Pest Control | 2026-08-03 | — | "Inspection Report" for 1030 Shannondale Rd - informational, no charge. No accompanying invoice email showed up in this run's window. |
...
- **QR Code Generator Pro** ($119.88, 2026-08-05) - new vendor flagged last
  run, likely an annual plan. Confirm this was intentional.
